...
import Data.ByteString.Lazy as B hiding (length)
import Data.Aeson
...
test' =
  do
    ...
    obj <- getNonJSONData "https://sandbox.iexapis.com/stable/time-series/REPORTED_FINANCIALS/AAPL/10-Q?last=1&token=Tpk_8d1fbeccf06745019a98635b05346b90"
    -- putStrLn $ show obj
...
-- https://sandbox.iexapis.com/stable/time-series/REPORTED_FINANCIALS/AAPL/10-Q?on=2020-01-01&token=Tpk_8d1fbeccf06745019a98635b05346b90
-- https://sandbox.iexapis.com/stable/stock/twtr/quote?token=Tpk_8d1fbeccf06745019a98635b05346b90
-- curl --header 'Accept: text/event-stream' https://sandbox-sse.iexapis.com/stable/forex1Second\?symbols\=USDCAD\&token\=Tpk_8d1fbeccf06745019a98635b05346b90
